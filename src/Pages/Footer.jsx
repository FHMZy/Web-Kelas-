					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/jangg_amii/?hl=id" class="hover:underline">
										Fahmi Musaddad
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/https.vanz/?hl=id" class="hover:underline">
										VanZ
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/11rpl2nesapa/?hl=id" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
									<a href="https://web.facebook.com/profile.php?id=61555853432401" class="hover:underline">
										Facebook
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas XI RPL 2 | Di Kelola Oleh Siswa RPL 2
						</p>
					</div>
				</div>
			</div>
